...
public class DBDataSource {
    ...
    public DefaultVinylService getVinylServiceImplementation() {
        return new DefaultVinylService(this.dataSource);
    }

    public JdbcVinylDao getJDBCVinylDAO() {
        return new JdbcVinylDao(this.dataSource);
    }
